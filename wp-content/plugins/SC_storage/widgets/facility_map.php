<?php
class facility_map extends WP_Widget{
    
    //process the new widget
    function facility_map() {
        $widget_ops = array( 
			'classname' => 'facility_map', 
			'description' => 'Provide a map with the location of a facility' 
			); 
        $this->WP_Widget( 'facility_map', 'Facility Map', $widget_ops );
    }
